...
/* package ParallelQuicksort-0.1.0.0 */
#ifndef VERSION_ParallelQuicksort
#define VERSION_ParallelQuicksort "0.1.0.0"
#endif /* VERSION_ParallelQuicksort */
#ifndef MIN_VERSION_ParallelQuicksort
#define MIN_VERSION_ParallelQuicksort(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ParallelQuicksort */
...
#define CURRENT_COMPONENT_ID "ParallelQuicksort-0.1.0.0-HgVIeKEkZEGGjD66wTy4V7-ParallelQuicksort"
